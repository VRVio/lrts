...
const Hero = () => {
  return (
    <div className="relative bg-gradient-to-br from-white to-blue-200 dark:from-gray-800 dark:to-blue-900 animate-gradient-x overflow-hidden">
            ...
            <div className="sm:text-center lg:text-left">
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Link
                    to="/zones"
                    className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-800 bg-blue-200 hover:bg-blue-300 dark:bg-blue-800 dark:text-blue-200 dark:hover:bg-blue-700 md:py-4 md:text-lg md:px-10 transition duration-300 ease-in-out transform hover:scale-105"
                  >
                    Explore Zones
                  </Link>
                </div>
